(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["madkudu"] = factory();
	else
		root["madkudu"] = factory();
...
var drop = __webpack_require__(33);
var rest = __webpack_require__(34);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(37)(module), __webpack_require__(6)))
...
var bindAll = __webpack_require__(0);
var clone = __webpack_require__(4);
var cookie = __webpack_require__(12);
var debug = __webpack_require__(1)('analytics.js:cookie');
var defaults = __webpack_require__(3);
var topDomain = __webpack_require__(35);
...
Cookie.prototype.options = function (options) {
  ...
  this.set('mkjs:test', true);
  if (!this.get('mkjs:test')) {
    debug('fallback to domain=null');
    this._options.domain = null;
  }
  this.remove('mkjs:test');
};
...
var debug = __webpack_require__(28)('cookie');
...
var debug = __webpack_require__(1)('analytics:entity');
var defaults = __webpack_require__(3);
var extend = __webpack_require__(39);
var memory = __webpack_require__(40);
var store = __webpack_require__(14);
var isodateTraverse = __webpack_require__(41);
...
Entity.prototype.initialize = function () {
  cookie.set('mkjs:cookies', true);

  // cookies are enabled.
  if (cookie.get('mkjs:cookies')) {
    cookie.remove('mkjs:cookies');
...
var settings = {"tenant":"3733","api_key":"a954d219bd2e4cd72a12f1309624ef05","form":{"active":true,"campaigns":[{"trigger":{"js":"var d = new Date();\nvar n = d.getTime();\nconsole.log('Madkudu: ' + n);\n\nvar interval = setInterval(doStuff, 200);\nfunction doStuff() {\n    if ($('input.hs-input[name=\"email\"]').length) {\n        clearInterval(interval);\n        var email = $('input.hs-input[name=\"email\"]');\n\t\tform.track_input(email);\n\t}\n}\n\n//var email = $('input.hs-input[name=\"email\"]');\n//form.track_input(email);"},"_id":"rJKjanHGZ","updated_at":"2017-12-01T21:22:47.975Z","created_at":"2017-06-07T17:53:36.563Z","active":true,"name":"Fast lane - enterprise demo","description":"","custom_css":"","custom_js":"","tenant":3733,"variations":[{"on_load":{"js":"console.log('v1.07');\n\n$(document).on('click', '#continueBtn', function() {\n  var $email = $('input.hs-input[name=\"email\"]').val();\n  console.log('$email: ' + $email);\n  form.qualify({ email: $email });\n});"},"on_qualified":{"js":"$('.hs_demo_request_from_form').attr('data-show', '1');"},"on_not_qualified":{"js":""},"on_request":{"js":""},"updated_at":"2017-12-01T21:22:47.976Z","created_at":"2017-12-01T21:22:47.976Z","name":"New variation","description":"","active":true,"weight":1000,"_id":"BygFip3rz-"}],"url_conditions":[{"match_type":"simple","_id":"BycezpSGZ","value":"https://www.beta-www.invisionapp.com/"},{"match_type":"simple","value":"(https://www.beta-www.invisionapp.com/trial/enterprise|https://www.beta-www.invisionapp.com/enterprise/signup|https://www.beta-www.invisionapp.com/enterprise/trial|https://www.local.invisionapp.com/enterprise/trial|https://www.local.invisionapp.com/enterprise/signup)","_id":"SJPJ8GfuW"}],"__v":0},{"trigger":{"js":""},"_id":"RCALdDDTGK","active":true,"name":"MK Customer Fit Cookie","description":"","url_conditions":[{"match_type":"simple","value":"https://projects.invisionapp.com/d/main","_id":"LAHt-m_Zj3"},{"match_type":"simple","value":"","_id":"RDMMBVIjY"}],"custom_css":"","custom_js":"","variations":[{"on_load":{"js":"var MK_COOKIE_NAME = 'mk_customer_fit_score';\nvar COOKIE_EXPIRATION_IN_DAYS = 90;\nvar COOKIE_DOMAIN = 'invisionapp.com';\n\nfunction setCookie(cname, cvalue, cdomain, exdays) {\n    var d = new Date();\n    d.setTime(d.getTime() + (exdays*24*60*60*1000));\n    var expires = \"expires=\"+ d.toUTCString();\n    document.cookie = cname + \"=\" + cvalue + \";\" + expires + \";path=/\" + ';domain=' + cdomain;\n}\n\nvar add_mk_score_into_a_cookie = function() {\n  setCookie(MK_COOKIE_NAME, madkudu && madkudu.user && madkudu.user().traits && madkudu.user().traits().customer_fit && madkudu.user().traits().customer_fit.score, COOKIE_DOMAIN, COOKIE_EXPIRATION_IN_DAYS)\n}\n\n// check if we've already added a cookie to with the mk fit score\n// why we check: if we've done that already, do nothing. Else qualify and add cookie\nif ( document.cookie.indexOf(MK_COOKIE_NAME) === -1 ) {\n  // check if this visitor has an identified email\n  if ( madkudu && madkudu.user && madkudu.user().traits && madkudu.user().traits().email && madkudu.user().traits().email !== '') {\n    // check if MadKudu's qualification is already there\n    if (madkudu && madkudu.user && madkudu.user().traits && madkudu.user().traits().customer_fit) {\n      // just add the cookie with the score\n      add_mk_score_into_a_cookie()\n    }\n    else {\n      // qualify first and then add cookie\n      madkudu.user().qualify(function(err, res) {\n        add_mk_score_into_a_cookie()\n      });\n    }\n  }\n}"},"on_qualified":{"js":""},"on_not_qualified":{"js":""},"on_request":{"js":""},"name":"New variation","description":"","active":true,"weight":1000,"_id":"gdvJvoJxJ","created_at":"2018-08-21T16:51:11.801Z","updated_at":"2018-08-21T16:51:11.801Z"}],"tenant":3733,"created_at":"2018-08-21T16:51:11.802Z","updated_at":"2018-08-21T16:51:11.802Z","__v":0}]}};
/* eslint-enable no-undef */

var MadKudu = __webpack_require__(25);

var madkudu = new MadKudu();
madkudu.VERSION = '1.4.3';
...
var nextTick = __webpack_require__(26);
var cookie = __webpack_require__(11);
var store = __webpack_require__(14);
...
var uuid = __webpack_require__(19).v4;
var md5 = __webpack_require__(59).hash;
var Form = __webpack_require__(60);
var defaults = __webpack_require__(3);
var pageDefaults = __webpack_require__(73);

var debug = __webpack_require__(1)('madkudu.js');
...
MadKudu.prototype._options = function () {
...
MadKudu.prototype._settings = function () {
...
MadKudu.prototype.init = MadKudu.prototype.initialize = function () {
  var _this2 = this;
...
MadKudu.prototype.normalize = function (msg) {
  ...
  if (!ctx.library) {
    ctx.library = { name: 'madkudu.js', version: this.VERSION };
  }
...
MadKudu.prototype._send_get = function (url, data, headers, fn) {
  var req = new XMLHttpRequest();
  var params = data ? '?' + querystring.stringify(data) : '';

  req.open('GET', url + params, true);
  req.onerror = fn;
  req.onreadystatechange = function () {
    if (req.readyState === XHR_READY_SATE.done) {
      fn(null, req);
    }
  };
...
MadKudu.prototype.send = function (route, data) {
  var _this3 = this,
  ...
  var sendAjax = function sendAjax() {
    ...
    _this3._send_json(url, msg, headers, function (err, res) {
      _this3.debug('ajax sent %o, received %o', msg, _arguments);
      if (err) {
        return fn(err);
      }
      res.url = url;
...
MadKudu.prototype.request = function (route, data, fn) {
  ...
  this._send_get(url, data, headers, function (err, res) {
    if (err) {
      return fn(err);
    }
    try {
...
MadKudu.prototype.persons = function (data, callback) {
  var route = '/persons';
...
MadKudu.prototype._init_form = function (campaignSettings) {
  try {
    var form = new Form(this, campaignSettings);
    form.init();
...
MadKudu.prototype._init_forms = function () {
  ...
  for (var i = 0; i < campaigns.length; i++) {
    var campaignSettings = campaigns[i];
    this._init_form(campaignSettings);
  }
};
...
var bindAll = __webpack_require__(0);
var debug = __webpack_require__(1)('analytics:user');
...
User.prototype.customer_fit_segment = function () {
  return this.customer_fit().segment;
};
...
User.prototype.qualify = function (fn) {
  ...
  this.persons(function (err, res) {
    ...
    _this.identify(_this.id(), traits);
    fn(null, traits);
  });
  return this;
};
...
var isodate = __webpack_require__(44);
...
var toFunction = __webpack_require__(43);
...
var Entity = __webpack_require__(15);
var bindAll = __webpack_require__(0);
var debug = __webpack_require__(1)('analytics:group');
var inherit = __webpack_require__(18);
...
var JSON = __webpack_require__(7);
var base64encode = __webpack_require__(49);
var cors = __webpack_require__(51);
...
var utf8Encode = __webpack_require__(50);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($, each, querystring, type, component_event, is, isMeta, prevent) {

var Emitter = __webpack_require__(9);
var modalTemplate = __webpack_require__(65);
__webpack_require__(68);

var Form = function Form(madkudu, settings) {
...
Form.prototype.initialize_variation = function () {
  ...
  each(function (event) {
    ...
    _this.variation[method] = _this.variation[method] || {}; // make sure the object exists
    _this.variation[method].js = _this.variation[method].js || ''; // make sure the js exists
    // create a function using the string and bind it to the form
    _this['_' + method] = new Function('form', '$', _this.variation[method].js).bind(_this); // eslint-disable-line
    _this[method] = function () {
      return _this['_' + method](_this, $);
    }; // call the previous method with this and $ as arguments (to make them available in the execution context)
  }, this.events);
};
...
Form.prototype.initialize_events = function () {
  ...
  each(function (event) {
    _this2.on(event, function (props) {
      _this2[event](props);
    });
  }, this.events);
};
...
Form.prototype.qualify = function (props) {
  ...
  if (props && props.email && props.email !== this.email && this.is_email(props.email)) {
    ...
    this.madkudu.user().qualify(function (err, results) {
      if (err) {
        return _this3.log(err);
      }
      _this3.qualify_results(results);
    });
  }
  this.on_qualify();
};
...
Form.prototype.track_element = function (elements) {
  var events = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'blur';
  ...
  each(function (el) {
    ...
    on(el, events, function (e) {
      ...
      _this4.emit(action, props);

      if (href && el.target !== '_blank' && !isMeta(e)) {
        prevent(e);
        _this4.madkudu._callback(function () {
...
Form.prototype.mask_email_address = function (email) {
...
Form.prototype.track_input = function (elements, events) {
  ...
  this.track_element(elements, events, 'qualify', function (el) {
    return { email: _this5.gdpr_compliant ? _this5.mask_email_address(el.value) : el.value };
  });
};

Form.prototype.track_cta = function (elements, events, type) {
  var handler = function handler(el, e) {
    return {
      cta: {
        type: type,
...
Form.prototype.show_calendar = function () {
  var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
Form.prototype.show_modal = function () {
  var _this6 = this;
...
module.exports = Form;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(8), __webpack_require__(23), __webpack_require__(22), __webpack_require__(2), __webpack_require__(62), __webpack_require__(10), __webpack_require__(63), __webpack_require__(64)))
...
var pug = __webpack_require__(66);

function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (cta_no, cta_yes, subtitle, title) {pug_html = pug_html + "\u003Cdiv class=\"madkudu_modal open\"\u003E\u003Cdiv class=\"madkudu_modal__overlay\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"madkudu_modal__canvas\"\u003E\u003Cdiv class=\"madkudu_modal__box_parent\"\u003E\u003Cdiv class=\"madkudu_modal__box\"\u003E\u003Cdiv class=\"madkudu_modal__title\"\u003E" + (pug.escape(null == (pug_interp = title) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"madkudu_modal__subtitle\"\u003E" + (pug.escape(null == (pug_interp = subtitle) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"div\"\u003E\u003Cbutton class=\"madkudu_modal__button--primary madkudu_modal__accept\"\u003E" + (pug.escape(null == (pug_interp = cta_yes) ? "" : pug_interp)) + "\u003C\u002Fbutton\u003E\u003Cbutton class=\"madkudu_modal__button--secondary madkudu_modal__cancel\"\u003E" + (pug.escape(null == (pug_interp = cta_no) ? "" : pug_interp)) + "\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"madkudu_modal__branding\"\u003EPowered by \u003Ca href=\"http:\u002F\u002Fwww.madkudu.com?utm_campaign=smart_form\" target=\"_blank\"\u003EMadKudu\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";}.call(this,"cta_no" in locals_for_with?locals_for_with.cta_no:typeof cta_no!=="undefined"?cta_no:undefined,"cta_yes" in locals_for_with?locals_for_with.cta_yes:typeof cta_yes!=="undefined"?cta_yes:undefined,"subtitle" in locals_for_with?locals_for_with.subtitle:typeof subtitle!=="undefined"?subtitle:undefined,"title" in locals_for_with?locals_for_with.title:typeof title!=="undefined"?title:undefined));;return pug_html;};
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../css-loader/index.js??ref--2-1!../../../less-loader/dist/cjs.js!./madkudu.less", function() {
			var newContent = require("!!../../../css-loader/index.js??ref--2-1!../../../less-loader/dist/cjs.js!./madkudu.less");
...
var canonical = __webpack_require__(74);
var includes = __webpack_require__(75);
